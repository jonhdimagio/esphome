...
namespace ld2410_ts {
  ...
  struct data {
      ...
      struct sensorinfo detect_distance = {"detect_dist"  , UINT16_MAX, 10000, {0, 1}};
      struct sensorinfo mov_distance =    {"mov_dist"     , UINT16_MAX, 10000, {0, 1}};
      struct sensorinfo occ_distance =    {"occ_dist"     , UINT16_MAX, 10000, {0, 1}};
      struct sensorinfo mov_energy =      {"mov_ener"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo occ_energy =      {"occ_ener"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_mov_0 =        {"en_mov_0"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_mov_1 =        {"en_mov_1"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_mov_2 =        {"en_mov_2"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_mov_3 =        {"en_mov_3"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_mov_4 =        {"en_mov_4"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_mov_5 =        {"en_mov_5"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_mov_6 =        {"en_mov_6"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_mov_7 =        {"en_mov_7"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_mov_8 =        {"en_mov_8"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_occ_0 =        {"en_occ_0"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_occ_1 =        {"en_occ_1"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_occ_2 =        {"en_occ_2"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_occ_3 =        {"en_occ_3"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_occ_4 =        {"en_occ_4"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_occ_5 =        {"en_occ_5"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_occ_6 =        {"en_occ_6"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_occ_7 =        {"en_occ_7"     , UINT16_MAX, 100, {0, 1}};
      struct sensorinfo en_occ_8 =        {"en_occ_8"     , UINT16_MAX, 100, {0, 1}};
  };
